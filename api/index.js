...
app.post('/api/auth/send-otp', async (req, res) => {
  try {
    ...
    if (process.env.SMTP_USER) {
      ...
      // â”€â”€ Accent theme selection â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      // Purely a visual presentation feature â€” has zero connection to OTP
      // generation or authentication logic.
      const accentThemes = [
        { accent: '`${accent}', dark: '#2416B5' }, // original indigo
        { accent: '#1747D1', dark: '#1237A4' }, // royal blue
        { accent: '#5B2ACF', dark: '#431E9E' }, // violet
        { accent: '#006BCE', dark: '#00529F' }, // sky blue
        { accent: '#2838C7', dark: '#1D2998' }, // cobalt
      ];
      const { accent, dark: accentDark } = accentThemes[Math.floor(Math.random() * accentThemes.length)];
                ...
                <tr>
                  <td style="padding-bottom:36px;">
                    ...
                    <table border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td style="display:block;width:40px;height:11px;background:${accent};border-radius:6px;font-size:1px;line-height:1px;">&nbsp;</td>
                      </tr>
                      <tr><td style="height:3px;font-size:1px;line-height:1px;">&nbsp;</td></tr>
                      <tr>
                        <td style="display:block;width:11px;height:38px;background:${accent};border-radius:6px;font-size:1px;line-height:1px;">&nbsp;</td>
                      </tr>
                    </table>
                    <!-- Brand name -->
