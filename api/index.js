              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <table border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td>
                          <table border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td width="38" height="16" style="width:38px;height:16px;background:#3020d2;border-radius:7px 7px 3px 3px;font-size:1px;line-height:1px;">&nbsp;</td>
                            </tr>
                            <tr><td height="3" style="font-size:1px;line-height:1px;">&nbsp;</td></tr>
                            <tr>
                              <!-- Stem of F -->
                              <td width="12" height="36" style="width:12px;height:36px;background:#3020d2;border-radius:0 0 8px 8px;font-size:1px;line-height:1px;">&nbsp;</td>
                            </tr>
                          </table>
                        </td>
                      </tr>
                ...
                <tr>
                  <td align="center" style="padding:22px 0 28px;">
                    <table border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="11" height="11" style="width:11px;height:11px;background:#3020d2;border-radius:50%;font-size:1px;line-height:1px;">&nbsp;</td>
                      </tr>
                    </table>
                  </td>
                </tr>
                ...
                <tr>
                  <td align="center" style="padding-bottom:16px;">
                    <p style="margin:0;font-size:21px;font-weight:700;color:#3020d2;line-height:1;">FP</p>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="padding-bottom:3px;">
                    <p style="margin:0;font-size:10px;font-weight:600;color:#3020d2;">PENDING</p>
                  </td>
                </tr>
                <tr>
                  <td>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td style="padding:38px 40px 0 40px;">
                    ...
                    <p style="margin:0 0 26px;font-size:11px;font-weight:700;letter-spacing:4px;color:#3020d2;">SECURITY CHECK</p>

                    <!-- Map dots decoration (right-aligned, 3 rows to suggest world map) -->
                    <table border="0" cellspacing="0" cellpadding="0" align="right" style="margin-left:8px;margin-bottom:-120px;">
                      <!-- Row 1 – Europe/Asia dots -->
                      <tr>
                      ...
                      <tr>
                        ...
                        <td width="5" height="5" style="width:5px;height:5px;background:#c6c6d9;border-radius:50%;font-size:1px;">&nbsp;</td><td width="4">&nbsp;</td>
                        <td width="5" height="5" style="width:5px;height:5px;background:#c6c6d9;border-radius:50%;font-size:1px;">&nbsp;</td><td width="4">&nbsp;</td>
                        <td width="5" height="5" style="width:5px;height:5px;background:#3020d2;border-radius:50%;font-size:1px;">&nbsp;</td><td width="4">&nbsp;</td>
                        <td width="5" height="5" style="width:5px;height:5px;background:#c6c6d9;border-radius:50%;font-size:1px;">&nbsp;</td><td width="4">&nbsp;</td>
                        <td width="5" height="5" style="width:5px;height:5px;background:#c6c6d9;border-radius:50%;font-size:1px;">&nbsp;</td><td width="4">&nbsp;</td>
                        <td width="5" height="5" style="width:5px;height:5px;background:#3020d2;border-radius:50%;font-size:1px;">&nbsp;</td><td width="4">&nbsp;</td>
                        <td width="5" height="5" style="width:5px;height:5px;background:#c6c6d9;border-radius:50%;font-size:1px;">&nbsp;</td><td width="4">&nbsp;</td>
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" style="margin:28px 0 30px;">
                      <tr>
                        <td width="56" height="4" style="width:56px;height:4px;background:#3020d2;font-size:1px;line-height:1px;">&nbsp;</td>
                      </tr>
                    </table>
                ...
                <tr>
                  <td style="padding:0 40px;">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom:8px;">
                      <tr valign="middle">
                        <td>
                          <p style="margin:0;font-family:Georgia,'Times New Roman',Times,serif;font-size:74px;line-height:.85;font-weight:600;letter-spacing:2px;color:#3020d2;white-space:nowrap;">${otp}</p>
                        </td>
                          ...
                          <table border="0" cellspacing="0" cellpadding="0">
                            <tr valign="top">
                              <td style="padding-right:12px;">
                                ...
                                <p style="margin:0;font-family:Georgia,'Times New Roman',Times,serif;font-size:31px;font-weight:500;line-height:1;color:#3020d2;">05:00</p>
                                <p style="margin:8px 0 0;font-size:9px;letter-spacing:2px;font-weight:700;color:#10213a;">MINUTES</p>
                              </td>
                              <!-- Right border accent -->
                              <td width="3" style="width:3px;background:#3020d2;font-size:1px;line-height:1px;">&nbsp;</td>
                            </tr>
                          </table>
                        </td>
                      </tr>
                      ...
                      <tr valign="top">
                        ...
                        <td width="46%" style="width:46%;border-right:1px solid #a2a7ad;padding-right:28px;">
                          <table border="0" cellspacing="0" cellpadding="0" style="margin-bottom:14px;">
                            <tr><td width="30" height="3" style="width:30px;height:3px;background:#3020d2;font-size:1px;line-height:1px;">&nbsp;</td></tr>
                          </table>
                          <p style="margin:0 0 12px;font-size:10px;font-weight:700;letter-spacing:2px;color:#3020d2;">REQUEST TIME</p>
                        ...
                        <td width="46%" style="width:46%;padding-left:28px;">
                          ...
                          <p style="margin:0 0 12px;font-size:10px;font-weight:700;letter-spacing:2px;color:#3020d2;">DEVICE</p>
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr valign="middle">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-bottom:1px dotted #c4c4c5;padding-bottom:14px;margin-bottom:14px;">
                      <tr valign="top">
                        <td width="38" style="padding-top:8px;padding-right:14px;">
                          <table border="0" cellspacing="0" cellpadding="0">
                            <tr><td width="26" height="3" style="width:26px;height:3px;background:#3020d2;font-size:1px;line-height:1px;">&nbsp;</td></tr>
                          </table>
                        </td>
                ...
                <tr>
                  <td style="padding:0 40px 36px;">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-top:1px solid #3020d2;padding-top:22px;">
                      <tr valign="top">

                        <!-- Col 1: Brand + tagline -->
                        <td width="33%" style="width:33%;padding-right:14px;">
                          <p style="margin:0 0 6px;font-family:Georgia,'Times New Roman',Times,serif;font-size:22px;font-weight:700;color:#10213a;">Freedom<span style="color:#3020d2;">Plan</span></p>
