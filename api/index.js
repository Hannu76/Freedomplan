                ...
                <tr>
                  <td style="padding-bottom:36px;">
                    ...
                    <table border="0" cellspacing="0" cellpadding="0">
                      <!-- Top bar -->
                      <tr>
                        <td colspan="2" width="38" height="14" style="width:38px;height:14px;background:${accent};border-radius:6px 6px 6px 0;font-size:1px;line-height:1px;">&nbsp;</td>
                      </tr>
                      <!-- Stem connector -->
                      <tr>
                        <td width="13" height="4" style="width:13px;height:4px;background:${accent};font-size:1px;line-height:1px;">&nbsp;</td>
                        <td width="25" height="4" style="width:25px;height:4px;font-size:1px;line-height:1px;">&nbsp;</td>
                      </tr>
                      <!-- Middle bar -->
                      <tr>
                        <td colspan="2" width="28" height="12" style="width:28px;height:12px;background:${accent};border-radius:0 6px 6px 0;font-size:1px;line-height:1px;">&nbsp;</td>
                      </tr>
                      <!-- Bottom stem -->
                      <tr>
                        <td width="13" height="24" style="width:13px;height:24px;background:${accent};border-radius:0 0 6px 6px;font-size:1px;line-height:1px;">&nbsp;</td>
                        <td width="25" height="24" style="width:25px;height:24px;font-size:1px;line-height:1px;">&nbsp;</td>
                      </tr>
                    </table>
                    <!-- Brand name -->
                  ...
                  <td style="padding:38px 40px 0 40px;" valign="top">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td valign="top" align="right" style="width:220px; overflow:hidden;">
                          <!-- Map dots decoration (Image based) -->
                          <div style="width:240px; margin-right:-20px; opacity:0.68;">
                            <!-- FREEDOMPLAN DOTTED WORLD MAP -->
                            <table role="presentation"
                              ...
                              <tr>
                                <td align="right"
                                  ...
                                  <img
                                    src="https://yourdomain.com/assets/freedomplan_dotted_world_map.png"
                                    width="530"
                                    alt="World Map"
                                    border="0"
                                    style="
