...
function renderTemplate({ otp, user, requestTime, device, theme }) {
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="position: relative; z-index: 2; height: 100%;">
                                <tr>
                                    ...
                                    <td valign="bottom" style="width: 40%; text-align: right; position: relative;">
                                        <img src="cid:hero-female" alt="Student" style="display: block; max-height: 320px; position: absolute; bottom: 0; right: 0;" />
                                    </td>
                                </tr>
                            </table>
                        </td>
