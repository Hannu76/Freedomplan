...
export const IMAGES = {
  ...
  lock: getImageUrl('images/lock-3d.png'),
  whatsapp: getImageUrl('images/whatsapp-3d.png'),
  forex_gbp_inr: getImageUrl('images/forex_gbp_inr.jpg'),
  conversion_equivalent: getImageUrl('images/conversion_equivalent.jpg'),
  custom_country_bg: getImageUrl('images/custom_country_bg.jpg'),
};
