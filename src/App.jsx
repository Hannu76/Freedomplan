          ...
          <div className="max-w-7xl mx-auto px-6 py-12 md:py-16">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8">
              <div className="col-span-1 md:col-span-2">
                ...
                <div className="space-y-3">
                  <p className="text-[10px] font-extrabold uppercase tracking-widest text-[#161C2D] dark:text-neutral-300">Get in Touch</p>
                  <a href="mailto:freedomplan786@gmail.com" className="inline-flex items-center gap-2 px-3.5 py-2.5 rounded-[12px] border border-[#EEF2F7] dark:border-neutral-800 bg-[#F9FBFD] dark:bg-neutral-900 text-sm font-semibold text-[#161C2D] dark:text-neutral-200 hover:shadow-md transition-all w-full sm:w-auto">
                  ...
                  <div className="flex items-center gap-2 flex-wrap">
                    <a href="#" title="Instagram" className="flex items-center gap-1.5 px-3 py-2 rounded-[12px] border border-[#EEF2F7] dark:border-neutral-800 bg-[#F9FBFD] dark:bg-neutral-900 text-xs font-bold text-[#667085] hover:text-[#E1306C] hover:bg-pink-50 transition-all">
                    ...
                    <a href="#" title="YouTube" className="flex items-center gap-1.5 px-3 py-2 rounded-[12px] border border-[#EEF2F7] dark:border-neutral-800 bg-[#F9FBFD] dark:bg-neutral-900 text-xs font-bold text-[#667085] hover:text-[#FF0000] hover:bg-red-50 transition-all">
                    ...
                    <a href="#" title="LinkedIn" className="flex items-center gap-1.5 px-3 py-2 rounded-[12px] border border-[#EEF2F7] dark:border-neutral-800 bg-[#F9FBFD] dark:bg-neutral-900 text-xs font-bold text-[#667085] hover:text-[#0077B5] hover:bg-blue-50 transition-all">
            ...
            <div className="border-t border-[#EEF2F7] dark:border-neutral-800 mt-12 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-4 text-xs font-bold text-[#667085] dark:text-neutral-500">
                <a href="https://freedomplan.vercel.app/" target="_blank" rel="noopener noreferrer" className="hover:text-[#161C2D] dark:hover:text-white transition-colors">Vercel App</a>
                <span className="w-1 h-1 rounded-full bg-[#D0D5DD] dark:bg-neutral-700"></span>
                <a href="https://freedomplan.guru" target="_blank" rel="noopener noreferrer" className="hover:text-[#161C2D] dark:hover:text-white transition-colors">freedomplan.guru</a>
                <span className="w-1 h-1 rounded-full bg-[#D0D5DD] dark:bg-neutral-700"></span>
