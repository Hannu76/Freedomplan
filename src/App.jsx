...
function AppShell() {
  ...
  return (
    <>
      ...
      <div className={`dark-invert min-h-screen flex flex-col text-[#161C2D] transition-colors duration-350 selection:bg-[#B6F36A] selection:text-[#161C2D] ${!darkMode ? 'bg-[#F6F8FC]' : 'bg-transparent'}`}>
        {!isFullPage && (
        ...
        {/* Main Container */}
        <main
          className={isFullPage ? "flex-1 w-full mx-auto overflow-hidden flex flex-col justify-center" : "flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 py-4 pb-0 overflow-hidden"}
