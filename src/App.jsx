...
import TargetAlertModal from './components/TargetAlertModal'
...
function AppShell() {
  const { darkMode, setDarkMode, soundEnabled, setSoundEnabled, rate, setRate, isBasicUnlocked, setIsBasicUnlocked, isProUnlocked, setIsProUnlocked, setProLeadData, isLoggedIn, isTargetAlertOpen, targetAlertData, closeTargetAlert } = useStore()
  ...
  return (
    <>
      ...
      >
        ...
        {/* Professional Footer */}
        <footer className="mt-20 border-t border-slate-200/50 rounded-t-[32px] shadow-[0_-10px_40px_rgba(102,51,238,0.12)] overflow-hidden relative isolate">
      ...
      />
      {/* Monthly Target Validation Alert Modal */}
      <TargetAlertModal
        isOpen={isTargetAlertOpen}
        onClose={closeTargetAlert}
        data={targetAlertData}
      />
    </>
  )
}
