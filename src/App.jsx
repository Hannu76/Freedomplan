...
function AppShell() {
  ...
  // Always force Overview ('dashboard') as default landing tab on app load/refresh
  useEffect(() => {
  ...
  return (
    <>
      ...
      {/* Main Container */}
      <main 
        className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 py-4 pb-0 overflow-hidden"
      ...
      >
        <SlideTransition activeTab={activeTab}>
          {activeTab === 'dashboard' && (
            <AsyncSkeletonWrapper isLoading={tabLoading} skeleton={<DashboardSkeleton />}>
              <Dashboard
          ...
          {activeTab === 'charts' && (
            <BlurGate isLocked={!isLocalhost && !isLoggedIn} onUnlock={() => { setPendingProtectedTab(activeTab); setIsProModalOpen(true); }}>
              <AsyncSkeletonWrapper isLoading={tabLoading} skeleton={<AnalyticsDashboardSkeleton />}>
                <AnalyticsDashboard
          ...
          {activeTab === 'accounts' && (
            <BlurGate isLocked={!isProUnlocked} title="Unlock Pro Access" message="Unlock Pro Access to access this premium feature." onUnlock={() => { setPendingProtectedTab(activeTab); setIsProModalOpen(true); }}>
              <AsyncSkeletonWrapper isLoading={tabLoading} skeleton={<AccountsManagerSkeleton />}>
                <AccountsManager />
              </AsyncSkeletonWrapper>
            </BlurGate>
          )}
          {activeTab === 'tracker' && (
            <BlurGate isLocked={!isProUnlocked} title="Unlock Pro Access" message="Unlock Pro Access to access this premium feature." onUnlock={() => { setPendingProtectedTab(activeTab); setIsProModalOpen(true); }}>
              <AsyncSkeletonWrapper isLoading={tabLoading} skeleton={<SavingsTrackerSkeleton />}>
                <SavingsTracker />
              </AsyncSkeletonWrapper>
            </BlurGate>
          )}
          {activeTab === 'converter' && (
            <BlurGate isLocked={!isProUnlocked} title="Unlock Pro Access" message="Unlock Pro Access to access this premium feature." onUnlock={() => { setPendingProtectedTab(activeTab); setIsProModalOpen(true); }}>
              <AsyncSkeletonWrapper isLoading={tabLoading} skeleton={<CurrencyConverterSkeleton />}>
                <CurrencyConverter />
              </AsyncSkeletonWrapper>
            </BlurGate>
          )}
          {activeTab === 'loan' && (
            <BlurGate isLocked={!isProUnlocked} title="Unlock Pro Access" message="Unlock Pro Access to access this premium feature." onUnlock={() => { setPendingProtectedTab(activeTab); setIsProModalOpen(true); }}>
              <AsyncSkeletonWrapper isLoading={tabLoading} skeleton={<LoanTrackerSkeleton />}>
                <LoanTracker />
              </AsyncSkeletonWrapper>
            </BlurGate>
          )}
