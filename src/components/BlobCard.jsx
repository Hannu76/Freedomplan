  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 rounded-[24px] overflow-hidden bg-white text-neutral-900 border border-[#0DCE4D]/40 shadow-md flex flex-col justify-between flex-1">
        ...
        <div
          className="relative overflow-hidden rounded-t-[24px] shrink-0 bg-[#FFFFFF]"
        ...
        >
          ...
          {/* FreedomPlan Brand Logo Badge in Top Right Corner */}
          <div 
            className="absolute top-3 right-3 z-20 pointer-events-none transition-all duration-300 ease-out opacity-100 translate-y-0 scale-100"
          >
            <div className="px-2.5 py-1 rounded-full bg-white/90 backdrop-blur-md shadow-md border border-emerald-400/30 flex items-center gap-1.5">
              <img 
                ...
                alt="FreedomPlan" 
                className="h-4 object-contain drop-shadow-[0_1px_1px_rgba(0,0,0,0.1)]" 
              />
            </div>
          </div>
