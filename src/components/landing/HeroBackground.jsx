...
export default function HeroBackground() {
  return (
    <div className="hero-decoration background-line absolute inset-0 overflow-hidden pointer-events-none z-[1]">
      {/* Desktop Background (md and above) */}
      <div
        className="hero-decoration background-line absolute inset-0 w-full h-full bg-cover bg-center bg-no-repeat hidden md:block"
        style={{
