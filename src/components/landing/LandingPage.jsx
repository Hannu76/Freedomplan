                ...
                >
                    ...
                    <div className="absolute inset-0 z-30 pointer-events-none px-4 sm:px-5 md:px-8 py-4 sm:py-6 md:py-8 flex flex-col justify-between">
                        ...
                        <div className="flex items-center justify-between w-full gap-3">
                            ...
                            {/* Top Left: Inset Logo Badge */}
                            <div className="pointer-events-auto bg-[#FEFEFE] shadow-[inset_0_1px_2px_rgba(0,0,0,0.04),0_8px_24px_rgba(0,0,0,0.08)] px-5 sm:px-7 py-2 sm:py-2.5 rounded-full flex items-center justify-center relative overflow-hidden group border border-[#E2E8F0]/90">
                                <div className="absolute inset-0 bg-gradient-to-r from-white/80 to-transparent translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-700 ease-in-out pointer-events-none"></div>
                                <img
                                    src="/images/freedom-plan-logo.png"
                                    alt="FreedomPlan"
                                    className="h-8 sm:h-10 md:h-11 w-auto max-w-[220px] sm:max-w-[260px] md:max-w-[290px] object-contain mix-blend-multiply"
                                />
                            </div>
