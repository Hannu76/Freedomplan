                ...
                >
                    ...
                    <div className="absolute inset-0 z-30 pointer-events-none px-4 sm:px-5 md:px-8 py-4 sm:py-6 md:py-8 flex flex-col justify-between">
                        ...
                        <div className="flex items-center justify-between w-full gap-3">
                            ...
                            {/* Top Left: Badge */}
                            <div className="pointer-events-auto bg-white shadow-xl px-5 sm:px-6 py-2.5 sm:py-3 rounded-full flex items-center justify-center relative overflow-hidden group border border-slate-100">
                            ...
                            <div className="pointer-events-auto flex flex-col items-center sm:items-end gap-1">
                                <ElasticStack
                                    ...
                                    className="py-0"
                                />
                                <div className="text-[#001C44] text-center sm:text-right mt-0.5">
                        ...
                        <div className="max-w-[840px] mt-auto mb-10 sm:mb-16 md:mb-20 flex flex-col items-start pointer-events-auto px-1">
                            ...
                            >
                                ...
                                <motion.span
                                    variants={{ hidden: { opacity: 0, y: 24 }, visible: { opacity: 1, y: 0, transition: { duration: 0.45, ease: [0.22, 1, 0.36, 1] } } }}
                                    className="font-extrabold text-transparent bg-clip-text"
                                    style={{ backgroundImage: BLACK_TEXT_URL, backgroundPosition: 'left center', backgroundSize: 'auto 150%', backgroundRepeat: 'repeat-x' }}
                                >Your</motion.span>
