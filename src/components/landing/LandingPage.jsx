                    ...
                    <div className="absolute inset-0 z-30 pointer-events-none px-4 sm:px-5 md:px-8 py-4 sm:py-6 md:py-8 flex flex-col justify-between">
                        ...
                        <div className="flex items-center justify-between w-full gap-3">
                            ...
                            <div className="pointer-events-auto flex flex-col items-center sm:items-end gap-1">
                                <ElasticStack
                                    ...
                                    className="py-0"
                                />
                                <div className="text-slate-800 dark:text-white text-center sm:text-right mt-0.5">
                                    <p className="text-[10px] font-extrabold uppercase tracking-widest leading-tight drop-shadow-sm">
                        ...
                        <div className="max-w-[840px] mt-auto mb-10 sm:mb-16 md:mb-20 flex flex-col items-start pointer-events-auto px-1">
                            ...
                            <p className="text-slate-600 text-base md:text-xl font-medium tracking-wide max-w-2xl leading-[1.6] mb-6 sm:mb-8">
                             ...
                             {/* Call to Actions - Side-by-side horizontal flex row on mobile, compact height (~25-30% smaller), pill-shaped */}
                            <div className="flex flex-row items-center gap-2.5 sm:gap-4.5 w-full sm:w-auto my-3 sm:mt-2">
                                ...
                                <div className="relative group flex-1 sm:flex-none">
                                    ...
                                    <button
                                        ...
                                        className="relative z-10 w-full sm:w-auto px-3.5 sm:px-8 py-2.5 sm:py-4 rounded-full font-bold sm:font-extrabold uppercase tracking-wider text-[12px] sm:text-xs transition-all bg-[#0B0F19] text-white hover:bg-[#161C2B] shadow-xl border border-slate-800 text-center flex items-center justify-center gap-1.5 overflow-hidden whitespace-nowrap active:scale-95"
                                    >
                                ...
                                <button
                                    ...
                                    className="flex-1 sm:flex-none w-full sm:w-auto px-3.5 sm:px-8 py-2.5 sm:py-4 rounded-full font-bold sm:font-extrabold uppercase tracking-wider text-[12px] sm:text-xs transition-all bg-white/70 hover:bg-white/90 border border-slate-300/90 text-slate-900 shadow-sm backdrop-blur-md text-center whitespace-nowrap active:scale-95"
                                >
                                    How It Works
                                </button>
                            </div>
