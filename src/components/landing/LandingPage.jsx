        ...
        <div className="relative w-full h-full min-h-screen overflow-x-clip">
            ...
            >
                ...
                >
                    ...
                    <div className="absolute right-6 lg:right-16 bottom-20 lg:bottom-24 z-10 hidden xl:flex items-center gap-6 p-5 rounded-2xl bg-white/45 backdrop-blur-xl border border-white/80 shadow-[0_20px_50px_rgba(0,0,0,0.06)] pointer-events-auto">
                        {/* Card 1: Smart Planning */}
                        <div className="flex flex-col items-center text-center px-4 py-1 border-r border-slate-200/60">
                    ...
                    {/* Ribbon wrapper — targeted by GSAP separately (z-20 overlay over 3D Feature Panel) */}
                    <div className="hero-ribbon absolute inset-0 w-full h-full z-20 pointer-events-none">
                    ...
                    <div className="absolute inset-0 z-30 pointer-events-none px-4 sm:px-5 md:px-8 py-4 sm:py-6 md:py-8 flex flex-col justify-between">
                        ...
                        <div className="flex items-center justify-between w-full gap-3">
                            ...
                            {/* Top Left: Brand Logo & UK Student Edition Badge */}
                            <div className="flex items-center gap-2.5 sm:gap-3 pointer-events-auto">
                                <img
                                    src="/images/freedom-plan-logo.png"
                                    alt="FreedomPlan"
                                    className="h-7 sm:h-8 md:h-9 object-contain mix-blend-multiply drop-shadow-sm"
                                />
                                <span className="text-neutral-800 text-[10px] uppercase font-bold px-2.5 sm:px-3 py-1 rounded-full border border-neutral-300/80 bg-white/80 backdrop-blur-md shrink-0">
                                    UK Student Edition
                                </span>
                            </div>

                            {/* Top Right: ElasticStack & Social Proof */}
                            <div className="pointer-events-auto flex items-center gap-2 sm:gap-3">
                                <ElasticStack
                                    ...
                                    className="py-0"
                                />
                                <div className="text-slate-800 text-right hidden lg:block">
                        ...
                        <div className="max-w-[840px] mt-auto mb-10 sm:mb-16 md:mb-20 flex flex-col items-start pointer-events-auto px-1">
                            ...
                            <motion.h1
                                ...
                                className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-black tracking-tighter leading-[1.08] mb-6 max-w-[840px] flex flex-wrap gap-x-[0.28em]"
                            >
                                ...
                                {/* ⬛ Standard Rich Black */}
                                <motion.span variants={{ hidden: { opacity: 0, y: 24 }, visible: { opacity: 1, y: 0, transition: { duration: 0.7, ease: [0.22, 1, 0.36, 1] } } }} className="text-slate-900">Your</motion.span>
                                ...
                                {/* ⬛ Standard Rich Black */}
                                <motion.span variants={{ hidden: { opacity: 0, y: 24 }, visible: { opacity: 1, y: 0, transition: { duration: 0.7, ease: [0.22, 1, 0.36, 1] } } }} className="text-slate-900">Before</motion.span>
                                ...
                                {/* ⬛ Standard Rich Black */}
                                <motion.span variants={{ hidden: { opacity: 0, y: 24 }, visible: { opacity: 1, y: 0, transition: { duration: 0.7, ease: [0.22, 1, 0.36, 1] } } }} className="text-slate-900">in the</motion.span>
                            ...
                            <p className="text-slate-600 text-base md:text-xl font-medium tracking-wide max-w-2xl leading-[1.6] mb-6 sm:mb-8">
                            ...
                            {/* Call to Actions */}
                            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4.5 w-full sm:w-auto mt-2">
                                {/* Primary Button with Glow Flare */}
                                <div className="relative group w-full sm:w-auto">
                                    ...
                                    <button
                                        ...
                                        className="relative z-10 w-full sm:w-auto px-8 py-4 rounded-full font-extrabold uppercase tracking-widest text-xs transition-all bg-[#0B0F19] text-white hover:bg-[#161C2B] shadow-xl border border-slate-800 text-center flex items-center justify-center gap-2 overflow-hidden"
                                    >
                                ...
                                <button
                                    ...
                                    className="w-full sm:w-auto px-8 py-4 rounded-full font-extrabold uppercase tracking-widest text-xs transition-all bg-white/60 hover:bg-white/80 border border-slate-300/90 text-slate-900 shadow-sm backdrop-blur-md text-center"
                                >
                                    See How It Works
                                </button>
                            </div>
