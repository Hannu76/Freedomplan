...
<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 400 200' width='400' height='200'>
  <defs>
    <linearGradient id='bg' x1='0' y1='0' x2='1' y2='1'>
      <stop offset='0%' stop-color='%231B6BFA'/>
      <stop offset='45%' stop-color='%230052CC'/>
      <stop offset='100%' stop-color='%23003DA5'/>
    </linearGradient>
    ...
    <g id='g'>
      ...
      <circle cx='100' cy='100' r='80' fill='none' stroke='%23ffffff' stroke-width='0.35' opacity='0.25'/>
      <circle cx='200' cy='100' r='80' fill='none' stroke='%23ffffff' stroke-width='0.35' opacity='0.25'/>
      <circle cx='300' cy='100' r='80' fill='none' stroke='%23ffffff' stroke-width='0.35' opacity='0.25'/>
      <path d='M0,50 Q100,-50 200,50 T400,50' fill='none' stroke='%2360A5FA' stroke-width='0.7' opacity='0.25'/>
      <path d='M0,150 Q100,250 200,150 T400,150' fill='none' stroke='%2360A5FA' stroke-width='0.7' opacity='0.25'/>
    </g>
  </defs>
  ...
  <use href='%23g' y='20'/>
  <use href='%23g' y='40'/>
  <path d='M0,0 h400 v85 Q200,0 0,85 z' fill='%23ffffff' opacity='0.12'/>
</svg>
`.trim().replace(/\n/g, '');
...
<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 400 200' width='400' height='200'>
  <defs>
    <linearGradient id='bgGraphite' x1='0' y1='0' x2='0' y2='1'>
      <stop offset='0%' stop-color='%23F42A4E'/>
      <stop offset='25%' stop-color='%23E11438'/>
      <stop offset='65%' stop-color='%23C8102E'/>
      <stop offset='100%' stop-color='%23A10A22'/>
    </linearGradient>
    ...
    <g id='gGraphite'>
      ...
      <circle cx='200' cy='100' r='80' fill='none' stroke='%23ffffff' stroke-width='0.35' opacity='0.25'/>
      <circle cx='300' cy='100' r='80' fill='none' stroke='%23ffffff' stroke-width='0.35' opacity='0.25'/>
      <path d='M0,50 Q100,-50 200,50 T400,50' fill='none' stroke='%23FFA6B6' stroke-width='0.7' opacity='0.25'/>
      <path d='M0,150 Q100,250 200,150 T400,150' fill='none' stroke='%23FFA6B6' stroke-width='0.7' opacity='0.25'/>
    </g>
  </defs>
            ...
            >
                ...
                >
                    ...
                    <div className="absolute inset-0 z-30 pointer-events-none px-4 sm:px-5 md:px-8 py-4 sm:py-6 md:py-8 flex flex-col justify-between">
                        ...
                        <div className="flex items-center lg:items-start justify-between w-full gap-3">

                            {/* Top Left: FreedomPlan Logo (Clean direct placement without white button) */}
                            <div className="freedom-plan-logo pointer-events-auto flex items-center">
                                <img
                                    src="/images/freedom-plan-logo.png"
                                    alt="FreedomPlan"
                                    className="h-12 sm:h-14 md:h-16 lg:h-20 xl:h-[88px] w-auto max-w-[240px] sm:max-w-[300px] md:max-w-[360px] lg:max-w-[440px] object-contain drop-shadow-[0_4px_16px_rgba(0,0,0,0.35)] transition-transform duration-300 hover:scale-105"
                                />
                            </div>
                        ...
                        <div className="max-w-[840px] mt-auto mb-10 sm:mb-16 md:mb-20 flex flex-col items-start pointer-events-auto px-1">
                            ...
                            >
                                ...
                                <motion.span
                                    ...
                                    className="font-extrabold text-transparent bg-clip-text whitespace-nowrap inline-block drop-shadow-[0_2px_8px_rgba(0,82,204,0.3)]"
                                ...
                                <motion.span
                                    variants={{ hidden: { opacity: 0, y: 24 }, visible: { opacity: 1, y: 0, transition: { duration: 0.45, ease: [0.22, 1, 0.36, 1] } } }}
                                    className="font-extrabold text-transparent bg-clip-text whitespace-nowrap inline-block drop-shadow-[0_2px_8px_rgba(200,16,46,0.3)]"
                            ...
                            <div className="flex flex-row items-center gap-2.5 sm:gap-4 w-full sm:w-auto my-3 sm:mt-2 flex-wrap">
                                ...
                                <div className="relative group flex-1 sm:flex-none">
                                    <div className="absolute -bottom-1.5 left-1/2 -translate-x-1/2 w-4/5 h-3 bg-black/60 blur-md rounded-full opacity-70 group-hover:opacity-100 group-hover:blur-lg transition-all duration-300 pointer-events-none" />
                                    <button
                                        onClick={onRequireAuth}
                                        className="relative z-10 w-full sm:w-auto px-4 sm:px-8 py-2.5 sm:py-3.5 rounded-full font-bold sm:font-extrabold uppercase tracking-wider text-[12px] sm:text-xs transition-all bg-[#10131A] hover:bg-[#161B26] text-white shadow-[inset_0_1px_1px_rgba(255,255,255,0.22),0_8px_20px_rgba(0,0,0,0.45)] border border-slate-700/80 text-center flex items-center justify-center gap-1.5 overflow-hidden whitespace-nowrap active:scale-95"
                                        style={{
                                    ...
                                    >
                                        ...
                                        <span className="absolute bottom-0 left-1/2 -translate-x-1/2 w-1/2 h-[2px] bg-gradient-to-r from-transparent via-slate-400/60 to-transparent rounded-full opacity-80" />
                                    </button>
                                </div>

                                {/* Premium CTA — Get Instant Access */}
                                <div className="relative group flex-1 sm:flex-none">
                                    <div className="absolute -bottom-1.5 left-1/2 -translate-x-1/2 w-4/5 h-3 bg-[#0052CC] blur-md rounded-full opacity-85 group-hover:opacity-100 group-hover:blur-lg transition-all duration-300 pointer-events-none" />
                                    <button
                                        id="get-instant-access-btn"
                                        onClick={onOpenPayment}
                                        className="relative z-10 w-full sm:w-auto px-4 sm:px-8 py-2.5 sm:py-3.5 rounded-full font-bold sm:font-extrabold uppercase tracking-wider text-[12px] sm:text-xs transition-all bg-gradient-to-b from-[#1062EA] via-[#0052CC] to-[#003896] hover:brightness-110 text-white shadow-[inset_0_1px_1px_rgba(255,255,255,0.4),0_10px_25px_rgba(0,82,204,0.5)] border border-blue-400/40 text-center flex items-center justify-center gap-1.5 overflow-hidden whitespace-nowrap active:scale-95"
                                        style={{
                                    ...
                                    >
                                        ...
                                        <span className="absolute bottom-0 left-1/2 -translate-x-1/2 w-1/2 h-[2px] bg-gradient-to-r from-transparent via-blue-200 to-transparent rounded-full opacity-90" />
                                    </button>
                                </div>

                                {/* How It Works */}
                                <div className="relative group flex-1 sm:flex-none">
                                    <div className="absolute -bottom-1.5 left-1/2 -translate-x-1/2 w-4/5 h-3 bg-[#E11438] blur-md rounded-full opacity-85 group-hover:opacity-100 group-hover:blur-lg transition-all duration-300 pointer-events-none" />
                                    <button
                                        onClick={scrollToTrustedUniversities}
                                        className="relative z-10 w-full sm:w-auto px-4 sm:px-8 py-2.5 sm:py-3.5 rounded-full font-bold sm:font-extrabold uppercase tracking-wider text-[12px] sm:text-xs transition-all bg-gradient-to-b from-[#F22448] via-[#C8102E] to-[#99081E] hover:brightness-110 text-white shadow-[inset_0_1px_1px_rgba(255,255,255,0.4),0_10px_25px_rgba(200,16,46,0.5)] border border-red-400/40 text-center flex items-center justify-center gap-1.5 overflow-hidden whitespace-nowrap active:scale-95"
                                        style={{
                                    ...
                                    >
                                        ...
                                        <span className="absolute bottom-0 left-1/2 -translate-x-1/2 w-1/2 h-[2px] bg-gradient-to-r from-transparent via-rose-200 to-transparent rounded-full opacity-90" />
                                    </button>
                                </div>
                            </div>
                        </div>
