...
export default function TrustedUniversities({ onContact }) {
  ...
  return (
    <section
      ...
      className="relative z-30 w-full pt-10 sm:pt-12 md:pt-14 pb-7 sm:pb-8 md:pb-10 px-4 sm:px-6 flex flex-col items-center justify-center bg-gradient-to-b from-[#F8FAFC] via-[#FFFFFF] to-[#F8FAFC] dark:from-[#0B0F19] dark:via-[#0D1220] dark:to-[#0B0F19] border-t border-b border-slate-200/60 dark:border-slate-800/80 transition-colors overflow-hidden"
    >
      ...
      <div className="w-full relative max-w-7xl mx-auto overflow-hidden">
        ...
        <div className="absolute top-0 bottom-0 left-0 w-16 sm:w-28 bg-gradient-to-r from-[#F8FAFC] dark:from-[#0B0F19] to-transparent z-10 pointer-events-none" />
        <div className="absolute top-0 bottom-0 right-0 w-16 sm:w-28 bg-gradient-to-l from-[#F8FAFC] dark:from-[#0B0F19] to-transparent z-10 pointer-events-none" />
