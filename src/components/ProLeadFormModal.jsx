...
export default function ProLeadFormModal({ isOpen, onClose, onUnlock }) {
  ...
  // view can be 'email-check', 'register', 'login-request', 'login-otp'
  const [view, setView] = useState('email-check') 
          ...
          <div className="animate-fade-in relative z-10">
            ...
            <form onSubmit={(e) => e.preventDefault()} className="flex flex-col gap-5">
              ...
              <div className="flex gap-3 mt-2">
                <button type="button" onClick={() => { setView('email-check'); setError(''); }} className="px-4 py-3 rounded-xl text-xs font-bold text-neutral-600 hover:bg-neutral-100 transition-colors">Back</button>
