...
const API_BASE_URL = import.meta.env.VITE_API_URL || (isLocalhost ? 'http://localhost:3001/api/auth' : 'https://api.freedomplan.com/api/auth')
...
export default function ProLeadFormModal({ isOpen, onClose, onUnlock }) {
  ...
  const submitToGoogleSheetAPI = async (data) => {
    try {
      const GOOGLE_SHEETS_WEBHOOK_URL = 'https://script.google.com/macros/s/AKfycbyKoL4QFy5innXcEmcDY2RgIFiYHFBKOonSkSyChOp3Yjzt-pXSPnfjaJExCxDPyS0r/exec' 
