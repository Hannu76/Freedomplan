...
export default function ProLeadFormModal({ isOpen, onClose, onUnlock }) {
  ...
  const completeNewUserRegistration = () => {
    ...
    const newUserData = { ...formData, email: cleanEmail, isOutsideUK, tier: 'basic', timestamp }
    ...
    // Send to backend for admin email notification (fire-and-forget)
    try {
    ...
    setRegisteredData({ ...formData, isOutsideUK })
    setIsSubmitting(false)
