...
const GOOGLE_SHEET_EXISTING_CUSTOMERS_CACHE = new Map([
  ['naveedmd78600@gmail.com', { email: 'naveedmd78600@gmail.com', name: 'Naveed', loanAmount: 2500000, isOutsideUK: false, tier: 'basic' }],
  ['hannu786464@gmail.com', { email: 'hannu786464@gmail.com', name: 'Hannu', loanAmount: 2500000, isOutsideUK: false, tier: 'basic' }],
  ['jashujaswanth050@gmail.com', { email: 'jashujaswanth050@gmail.com', name: 'Jashu Jaswanth', loanAmount: 2500000, isOutsideUK: true, tier: 'basic' }],
  ['hannu464@gmail.com', { email: 'hannu464@gmail.com', name: 'Hannu 464', loanAmount: 2500000, isOutsideUK: false, tier: 'basic' }],
  ['renuka.yam.b19@gmail.com', { email: 'renuka.yam.b19@gmail.com', name: 'Renuka', loanAmount: 2500000, isOutsideUK: true, tier: 'basic' }],
  ['anasurrahmansheik@gmail.com', { email: 'anasurrahmansheik@gmail.com', name: 'Anasur Rahman Sheik', loanAmount: 2500000, isOutsideUK: true, tier: 'basic' }],
  ['pallapua954@gmail.com', { email: 'pallapua954@gmail.com', name: 'Pallapu', loanAmount: 2500000, isOutsideUK: true, tier: 'basic' }],
  ['harshadpashask@gmail.com', { email: 'harshadpashask@gmail.com', name: 'Harshad Pasha', loanAmount: 2500000, isOutsideUK: true, tier: 'basic' }],
  ['nagireddy7678@gmail.com', { email: 'nagireddy7678@gmail.com', name: 'Nagireddy', loanAmount: 2500000, isOutsideUK: true, tier: 'basic' }],
  ['naveedmd00@gmail.com', { email: 'naveedmd00@gmail.com', name: 'Naveed MD', loanAmount: 2500000, isOutsideUK: true, tier: 'basic' }],
  ['hannu4@outlook.com', { email: 'hannu4@outlook.com', name: 'Hannu Outlook', loanAmount: 2500000, isOutsideUK: false, tier: 'basic' }],
]);
...
export default function ProLeadFormModal({ isOpen, onClose, onUnlock }) {
  ...
  const completeExistingUserSession = (customer) => {
    ...
    const authenticatedUser = {
      ...
      premium: customer?.tier === 'pro' || customer?.isPremium || false,
      lastLogin: timestamp,
    }
        ...
        <AnimatePresence mode="wait">
                ...
                <div>
                  ...
                  {emailCheckStatus === 'existing' && (
                    ...
                    >
                      ...
                      <button
                        type="button"
                        onClick={() => { setView('existing-otp'); setResendTimer(30); }}
          ...
          {view === 'login' && (
            ...
            >
              ...
              <p className="text-xs text-neutral-500 mb-5">
                Enter your registered Gmail address to receive your login OTP.
              </p>
