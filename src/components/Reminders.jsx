    ...
    <div className="space-y-6">
      ...
      <Card eyebrow="Execution compliance" title="Monthly Reminders & Ledger Log">
        <div className="space-y-6">
          ...
          <div className="rounded-[18px] border border-emerald-500/30 bg-emerald-500/10 p-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs sm:text-sm">
            <div className="flex items-center gap-3 font-extrabold text-red-600">
            ...
            <span className="figure font-bold px-3.5 py-1.5 rounded-full bg-white border border-emerald-500/40 text-[#161C2D] text-xs shadow-sm-clean">
