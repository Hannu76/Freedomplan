  ...
  return (
    <div className="space-y-6 animate-slide-up">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
        ...
        />
        <StatTile
          label="Freedom Plan Forex Rate"
          value={`₹${(rate + 2).toFixed(2)} / £`}
          sub={`Live Rate: ₹${rate.toFixed(2)} + ₹2.00 Forex Processing Fee`}
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-[18px] border border-[#EEF2F7] bg-[#F9FBFD] p-6 shadow-sm-clean flex flex-col sm:flex-row items-center justify-between gap-4">
            <div>
              ...
              <p className="figure text-xl sm:text-3xl font-bold text-[#161C2D] tracking-tight break-words">
