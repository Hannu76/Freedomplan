...
export default function SavingsTracker() {
  const { timeline, entries, updateEntry, timelineConfig, updateTimelineConfig, derived, completeValueUpdate } = useStore()
                    ...
                    <td className="py-3.5 px-4">
                      <div className="relative inline-flex items-center">
                        ...
                        <input
                          ...
                          onBlur={() => completeValueUpdate({ target: derived.targetMonthlySavingsGBP, progress: r.saved })}
                          onKeyDown={(e) => e.key === 'Enter' && completeValueUpdate({ target: derived.targetMonthlySavingsGBP, progress: r.saved })}
