            ...
            >
              ...
              <div className="flex flex-col items-center justify-center text-center gap-2 border-b border-[#F1F5F9] pb-5">
                ...
                {planYear.isGraceYear && planYear.totalSkippedAmount > 0 && (() => {
                  const activeAllocationMode = graceAllocationMode === 'first_month' ? 'first_month' : 'split'
                  return (
                    <div className="w-full max-w-2xl mx-auto rounded-2xl bg-amber-50/90 border border-amber-200/90 p-4 sm:p-5 shadow-xs text-left my-2 animate-fade-in space-y-3 relative z-30">
                      <div className="flex items-start gap-3">
                        ...
                        <div className="space-y-1.5 flex-1">
                          ...
                          <div className="flex flex-wrap items-center gap-2 pt-2 border-t border-amber-200/60 relative z-40">
                            ...
                            <button
                              ...
                              onClick={(e) => {
                                e.preventDefault()
                                e.stopPropagation()
                                if (setGraceAllocationMode) setGraceAllocationMode('split')
                              }}
                              className={`px-3.5 py-1.5 rounded-full text-xs font-black transition-all cursor-pointer border shadow-xs select-none active:scale-95 ${
                                activeAllocationMode === 'split'
                                  ? 'bg-[#0F172A] text-white border-[#0F172A] ring-2 ring-slate-900/20'
                                  : 'bg-white text-[#475569] border-[#CBD5E1] hover:bg-amber-100/60 hover:border-amber-300'
                              }`}
                            >
                            ...
                            <button
                              ...
                              onClick={(e) => {
                                e.preventDefault()
                                e.stopPropagation()
                                if (setGraceAllocationMode) setGraceAllocationMode('first_month')
                              }}
                              className={`px-3.5 py-1.5 rounded-full text-xs font-black transition-all cursor-pointer border shadow-xs select-none active:scale-95 ${
                                activeAllocationMode === 'first_month'
                                  ? 'bg-[#0F172A] text-white border-[#0F172A] ring-2 ring-slate-900/20'
                                  : 'bg-white text-[#475569] border-[#CBD5E1] hover:bg-amber-100/60 hover:border-amber-300'
                              }`}
                            >
