...
import { Card, ProgressBar, StatTile, EditableStatTile, Badge, AnimatedCounter, BANKNOTE_URL, BEFORE_URL, BLACK_TEXT_URL } from './ui.jsx'
        ...
        <BlobCard
          ...
          header={
            <div className="flex flex-col items-start gap-1">
              ...
              <button
                onClick={() => { if (onRequirePro) onRequirePro(); else setWantsToDownload(true); }}
                className="w-full mt-4 py-2.5 px-4 rounded-xl bg-neutral-100 hover:bg-neutral-200 active:scale-[0.98] text-neutral-900 font-semibold text-xs border border-neutral-200/80 shadow-sm transition-all text-center cursor-pointer"
              >
                Get Instant Access
              </button>
            </div>
