...
`;
  ...
  const handleDownloadDashboard = () => {
    ...
    if (!isLocalhost && !isLoggedIn) {
      if (onRequireLogin) onRequireLogin(performPDFDownload)
    } else {
      performPDFDownload()
    }
  }
          ...
          <div className="mt-8 mb-10 animate-slide-in-bottom delay-300">
            <div className="flex flex-col lg:flex-row gap-6">
              ...
              <div className="flex-1 flex flex-col gap-6">
                ...
                {/* Support Card (dynamically fits empty space without stretching column) */}
                <div 
                  className="rounded-[24px] shadow-sm-clean p-4 sm:p-5 flex flex-col items-center text-center overflow-hidden border border-neutral-900"
                  style={{ 
                    flex: '1 1 0%', 
                    minHeight: '0', 
                    height: '100%', 
                ...
                >
                  <div className="flex flex-col h-full w-full max-w-sm mx-auto items-center justify-between">
                    
                    <div className="w-full">
                      <h2 className="text-lg font-extrabold text-white mb-0.5">
                        Get in Touch
                      </h2>
                      <p className="text-[11px] font-semibold text-neutral-400 mb-3">
                        Need help with your Freedom Plan?
                      </p>
                      
                      <div className="text-left w-full bg-neutral-900/50 border border-neutral-800 rounded-xl p-3 mb-3">
                        <ul className="space-y-1.5 text-[10px] text-neutral-300 font-medium grid grid-cols-2 gap-x-2">
                          <li className="flex items-center gap-1.5">
                            <span className="text-[#B6F36A]">✓</span> Repayment Q's
                          </li>
                          <li className="flex items-center gap-1.5">
                            <span className="text-[#B6F36A]">✓</span> Savings plan
                          </li>
                          <li className="flex items-center gap-1.5">
                            <span className="text-[#B6F36A]">✓</span> Account support
                          </li>
                          <li className="flex items-center gap-1.5">
                            <span className="text-[#B6F36A]">✓</span> General guide
                          </li>
                        </ul>
                      </div>
                    </div>

                    <div className="mb-2 flex justify-center w-full transform scale-90 origin-bottom">
                    ...
                    {subscribeStatus === 'success' && <p className="text-[10px] text-[#B6F36A] font-bold mt-1">Subscribed successfully!</p>}
                    {subscribeStatus === 'error' && <p className="text-[10px] text-red-400 font-bold mt-1">Please enter a valid email address.</p>}

                    <div className="w-full mt-auto">
                      <div className="italic text-[10px] text-neutral-500 mb-1">
                        "Every step toward financial freedom..."
                      </div>
