              ...
              <div className="flex-1 bg-white border border-[#EEF2F7] rounded-[24px] shadow-sm-clean p-6 lg:p-8 flex flex-col justify-start space-y-8">
                ...
                <div className="space-y-4 relative z-10 pt-4">
                  ...
                  <div className="relative pt-2">
                    <input 
                      ...
                      style={getSliderStyle(tempBasicLoan, 100000, 10000000)}
                ...
                <div className="space-y-4">
                  ...
                  <div className="relative pt-2">
                    <input 
                      ...
                      style={getSliderStyle(tempInterestRate, 1, 20)}
                      className="w-full h-2.5 bg-[#EEF2F7] rounded-full appearance-none cursor-grab active:cursor-grabbing hover:bg-[#D0D5DD] transition-colors range-3d"
                    />
                    <div className="flex justify-between text-[11px] font-bold text-[#98A2B3] mt-2 tracking-wider">
                      <span>1%</span>
                ...
                <div className="space-y-4">
                  ...
                  <div className="relative pt-2">
                    <input 
                      ...
                      style={getSliderStyle(tempMoratoriumMonths, 12, 72)}
                      className="w-full h-2.5 bg-[#EEF2F7] rounded-full appearance-none cursor-grab active:cursor-grabbing hover:bg-[#D0D5DD] transition-colors range-3d"
                    />
                    <div className="flex justify-between text-[11px] font-bold text-[#98A2B3] mt-2 tracking-wider">
                      <span>12 mos</span>
                ...
                <div className="pt-4 pb-2">
                  <button
                    ...
                    className="w-full py-3.5 px-6 rounded-xl font-extrabold text-sm tracking-wide text-white transition-all duration-200 shadow-lg hover:shadow-xl active:scale-[0.98] flex items-center justify-center gap-2"
                    style={{
                  ...
                  {showSavedNotification && (
                    <div className="mt-3 p-3 bg-emerald-50 border border-emerald-200 rounded-xl text-emerald-700 text-xs font-extrabold flex items-center justify-center gap-2 animate-fade-in">
                      ...
                      Settings saved to your profile and restored automatically upon login!
                    </div>
                  )}
                </div>
                ...
                <div className="bg-gradient-to-br from-lime-400 to-lime-500 rounded-[24px] p-8 text-center shadow-xl shadow-lime-500/20 text-neutral-950 relative overflow-hidden group border border-lime-300">
                  ...
                  <div className="flex items-center justify-center gap-2 mb-3 relative z-10">
                    <span className="text-6xl font-black tracking-tighter figure leading-none">
                       <AnimatedCounter prefix="₹" value={Math.round(P_0 * (R_annual / 100) * (M / 12))} />
                    </span>
                  </div>
                  <p className="text-sm font-semibold text-lime-900/80 mb-8 relative z-10">
                    Calculated at {R_annual}% for {M / 12} {M / 12 === 1 ? 'year' : 'years'} ({M} months)
                  </p>
