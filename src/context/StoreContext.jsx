...
export function StoreProvider({ children }) {
  ...
  // No Income Periods State (Multiple customized no-income periods)
  const [rawNoIncomePeriods, setNoIncomePeriods] = useLocalStorage(`${profilePrefix}.noIncomePeriods`, [])
  const noIncomePeriods = Array.isArray(rawNoIncomePeriods) ? rawNoIncomePeriods : []
