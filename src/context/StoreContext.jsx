...
export function StoreProvider({ children }) {
  ...
  const customPlan = useMemo(() => {
    // Calculate Post-Graduation Principal (P_grad) based on Grace Period and Co-Applicant
    ...
    // Dynamically calculate the monthly savings target based on the new principal
    const termMonths = 36
